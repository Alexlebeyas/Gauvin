...
class Contact(models.Model):
    ...
    phone_1 = models.CharField(
        db_column="cTelephone1",
        max_length=10,
        db_collation="SQL_Latin1_General_CP1_CI_AS",
        blank=True,
        null=True,
    )
    ext_1 = models.CharField(
        db_column="cPoste1",
        max_length=5,
        db_collation="SQL_Latin1_General_CP1_CI_AS",
        blank=True,
    ...
    phone_2 = models.CharField(
        db_column="cTelephone2",
        max_length=10,
        db_collation="SQL_Latin1_General_CP1_CI_AS",
        blank=True,
        null=True,
    )
    ext_2 = models.CharField(
        db_column="cPoste2",
        max_length=5,
        db_collation="SQL_Latin1_General_CP1_CI_AS",
        blank=True,
    ...
    windows_directory = models.CharField(
        db_column="cRepertoireWindows",
        max_length=250,
        db_collation="SQL_Latin1_General_CP1_CI_AS",
        blank=True,
        null=True,
    ...
    cellphone_3 = models.CharField(
        db_column="cTelephone3",
        max_length=10,
        db_collation="SQL_Latin1_General_CP1_CI_AS",
        blank=True,
        null=True,
    )
    ext_3 = models.CharField(
        db_column="cPoste3",
        max_length=5,
        db_collation="SQL_Latin1_General_CP1_CI_AS",
        blank=True,
    ...
    cell_owner = models.CharField(
        db_column="cProprietaireCellulaire",
        max_length=50,
        db_collation="SQL_Latin1_General_CP1_CI_AS",
        blank=True,
        null=True,
...
class User(AbstractUser):
    ...
    username = models.CharField(
        db_column="strUsername",
        max_length=50,
        db_collation="SQL_Latin1_General_CP1_CI_AS",
        blank=True,
        null=True,
    )
    strpassword = models.CharField(
        db_column="strPassword",
        max_length=50,
        db_collation="SQL_Latin1_General_CP1_CI_AS",
        blank=True,
        null=True,
